function [r_ECI, v_ECI] = OE2ECI(OE)
    ...
    sent1 = ['The Initial Position is ', '(',num2str(r_ECI(1)),' ',num2str(r_ECI(2)),' ',num2str(r_ECI(3)),')'];
    disp(sent1)
    
    sent2 = ['The Initial Velocity is ', '(',num2str(v_ECI(1)),' ',num2str(v_ECI(2)),' ',num2str(v_ECI(3)),')'];
    disp(sent2)
